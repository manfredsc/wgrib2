/** @file
 * @brief Orthographic - Inverse Transformation
 * 
 * PURPOSE: Transforms input Easting and Northing to longitude and
 *          latitude for the Orthographic projection. The Easting and
...
/** 
 * Initialize the Orthographic projection for inverse transformation.
 * 
