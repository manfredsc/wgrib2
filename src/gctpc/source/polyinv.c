/** @file
 * @brief Polyconic - Inverse Transformation
 * 
 ...
 * 1/1998 | S. Nelson | If an error occurs in the phi4z call from polyinv, the 
 *                      error flag number from phi4z will be returned instead 
 *                      of 74 as before.
 */
...
/** 
 * Initialize the POLYCONIC projection for inverse transformation.
 * 
 ...
 * @param lon Pointer to store the longitude result
 * @param lat Pointer to store the latitude result
 * 
