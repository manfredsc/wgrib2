/** @file
 * @brief Robinson - Forward Transformation
 * 
 * PURPOSE: Transforms input longitude and latitude to Easting and
 *          Northing for the Robinson projection. The longitude and
 *          latitude must be in radians. The Easting and Northing
...
/** 
 * Initialize the ROBINSON projection for forward transformation.
 * 
