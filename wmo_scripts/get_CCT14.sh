...
wget -nv "$urlbase/raw/master/C14.csv" -O- | sed '{
  ...
  BEGIN {
    ...
    print " * This file is generated by get_CCT14.sh."
    print " * @author Wesley Ebisuzaki @date 2009"
    print " */"
    print ""
    print "#include \"wgrib2.h\""
    print ""
    print "/** Struct for Code Table 4.230 (Atmospheric chemical constituent type) */"
