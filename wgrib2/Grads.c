/** @file
 * @brief Options that are used by g2ctl (making GrADS control files for grib2 files).
 * 
 * ### Program History Log
 * Date | Programmer | Comments
 * -----|------------|---------
 * 2007 | W. Ebisuzaki | Initial
 * 1/2008 | S. Varlamov | double precision, bug fix
 * 1/2008 | W. Ebisuzaki  | f_domain added
 * 11/2009 | W. Ebisuzaki | f_domain fixed E-W calculation
...
/**
 * Inventory dump for g2ctl/GrADS.
 * 
 * ## Warning
...
/**
 * Find rectangular domain for g2ctl/GrADS plots.
 * 
 * The -options option finds a rectangular box that encompasses the grid. This option 
 * does not print out the vertices of the grid. Requirements for this option are 
 * determined by g2ctl. 
 * 
 * ## Usage
 * -domain
