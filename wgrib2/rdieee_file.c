/** @file
 * @brief Routines for reading IEEE floating point files.
...
#include "wgrib2.h"
 ...
 /** Number of floats to process at one time. */
#define BSIZ 8*4096
...
/**
 * Reads a big/little endian IEEE file with optional header.
 *
 ...
 * @param input Pointer to the input file struct.
 * 
